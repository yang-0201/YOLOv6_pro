...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--output-dir', default='algae', type=str, help='path to save outputs')
    parser.add_argument('--name', default='yolov6l', type=str, help='experiment name, saved to output_dir/name')
